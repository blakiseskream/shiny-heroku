...
Now we need to modify the `run.R` file to run *behind* NGINX. We can modify our existing `run.R` file by replacing it the following code,
...
** Challenge:** Danielle, while I'm getting an ultrasound can you incorporate this script into `run.R`? You will need to register an OAuth app on your *personal* Github account.
